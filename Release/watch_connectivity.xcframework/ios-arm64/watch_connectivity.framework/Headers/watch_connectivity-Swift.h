...
#ifndef WATCH_CONNECTIVITY_SWIFT_H
#define WATCH_CONNECTIVITY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="watch_connectivity",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18watch_connectivity28SwiftWatchConnectivityPlugin")
@interface SwiftWatchConnectivityPlugin : NSObject <FlutterPlugin, WCSessionDelegate>
